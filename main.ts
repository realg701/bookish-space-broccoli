...
const reverseString = (myString: string): string => {
...
const myArray = (myNumbers: number[]): number[] => {
...
const getLargestNumber = (myNumbers: number[]): number[] => {
  if (myNumbers.length <= 1) {
    return myNumbers;
  } else {
    let largest = 0;
...
const findSecondLargest = (myNumbers: number[]): number[] => {
...
let numsArr: number[] = [1, 2, 16, 6, 5, 32];
...
const numbersDup: number[] = [1, 2, 32, 2, 4, 5, 4, 5, 32];
// console.log(findDuplicates(numbersDup));
const numbers: number[] = [1, 2, 3, 4, 5];
// console.log(findDuplicates(numbers));
const numbersNon: number[] = [];
// console.log(findDuplicates(numbersNon));
...
const printTopStudents = (students: Student[]): void => {
