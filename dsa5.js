...
*/
const manipulateArrays = (array1, array2) => {
...
console.log("Multiple of equal arrays':", manipulateArrays([1, 2, 3], [1, 2, 3]));
console.log("Middle of unequal length arrays':", manipulateArrays([1, 2, 3], [1, 2, 3, 4, 5]));
console.log("Sum of unequal value arrays':", manipulateArrays([1, 2, 3], [4, 5, 6]));
/*
...
console.log("First Letter of every String in Array's:", extractFirstLetters(["Alice", "Bob", "Charlie", "David", "Eve"]));
export {};
